...
class IntegrationsManagerTest: XCTestCase {
    ...
    func testReturnsTrueForPrimeDataIntegrationWhenDisablesEvent() {
        let enabled = IntegrationsManager.isTrackEvent("hello world", enabledForIntegration: "PrimeData.io", inPlan:["track":["hello world":["enabled":false]]])
        XCTAssert(enabled)
    }
