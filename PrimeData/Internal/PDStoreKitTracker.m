...
@interface PDStoreKitTracker ()

@property (nonatomic, readonly) PDAnalytics *analytics;
...
@implementation PDStoreKitTracker

+ (instancetype)trackTransactionsForAnalytics:(PDAnalytics *)analytics
{
    return [[PDStoreKitTracker alloc] initWithAnalytics:analytics];
}
