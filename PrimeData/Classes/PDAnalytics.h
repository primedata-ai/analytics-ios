 ...
 */
@property (nullable, nonatomic, strong, readonly) PDAnalyticsConfiguration *configuration DEPRECATED_MSG_ATTRIBUTE("One time use object");
...
/**
 * Returns a dictionary of integrations that are bundled. This is an internal PrimeData API, and may be removed at any time
 * without notice.
 */
...
- (nullable id<PDEdgeFunctionMiddleware>)edgeFunction;
