...
@protocol PDApplicationProtocol <NSObject>
...
#if TARGET_OS_IOS
@interface UIApplication (PDApplicationProtocol) <PDApplicationProtocol>
@end
#elif TARGET_OS_OSX
@interface NSApplication (PDApplicationProtocol) <PDApplicationProtocol>
@end
#endif
...
@class PDAnalyticsExperimental;
@class PDDestinationMiddleware;
...
@interface PDAnalyticsConfiguration : NSObject
 ...
 */
@property (nonatomic, strong, nullable) PDRequestFactory requestFactory;
...
/**
 * Set the default settings to use if PrimeData.com cannot be reached. 
 ...
 */
@property (nonatomic, strong, nullable) NSArray<id<PDMiddleware>> *middlewares DEPRECATED_MSG_ATTRIBUTE("Use .sourceMiddleware instead.");

/**
 * Set custom source middleware. Will be run before all integrations
 */
@property (nonatomic, strong, nullable) NSArray<id<PDMiddleware>> *sourceMiddleware;

/**
 * Set custom destination middleware. Will be run before the associated integration for a destination.
 */
@property (nonatomic, strong, nullable) NSArray<PDDestinationMiddleware *> *destinationMiddleware;
 ...
 */
@property (nonatomic, strong, nullable) id<PDEdgeFunctionMiddleware> edgeFunctionMiddleware;

/**
 * Register a factory that can be used to create an integration.
 */
- (void)use:(id<PDIntegrationFactory> _Nonnull)factory;

/**
 * Leave this nil for iOS extensions, otherwise set to UIApplication.sharedApplication.
 */
@property (nonatomic, strong, nullable) id<PDApplicationProtocol> application;
 ...
 *      }
 */
@property (nonatomic, strong, nullable) PDAdSupportBlock adSupportBlock;

/**
 Enable experimental features within the PrimeData Analytics-iOS library.
 */
@property (nonatomic, readonly, nonnull) PDAnalyticsExperimental *experimental;

@end

#pragma mark - Experimental

typedef  NSDictionary * _Nonnull (^PDRawModificationBlock)( NSDictionary * _Nonnull rawPayload);

NS_SWIFT_NAME(AnalyticsExperimental)
@interface PDAnalyticsExperimental : NSObject
/**
 ...
 */
@property (nonatomic, strong, nullable) PDRawModificationBlock rawPrimeDataModificationBlock;
