...
- (instancetype _Nonnull)initWithAnalytics:(PDAnalytics *_Nonnull)analytics
{
    ...
    if (self = [super init]) {
        ...
        [factories addObject:[[PDSegmentIntegrationFactory alloc] initWithHTTPClient:self.httpClient fileStorage:self.fileStorage userDefaultsStorage:self.userDefaultsStorage]];
